...
// src/main.ts
var MirrorUIPlugin = class extends import_obsidian4.Plugin {
  constructor() {
    super(...arguments);
  ...
  async addToolbarToActiveLeaf(file, file_target) {
    ...
    if (props) {
      ...
      if (cssClasses.includes("banner") && !mosxbanner) {
        new import_obsidian4.Notice("Removendo classe 'banner' porque 'mosxbanner' nao esta presente ou nao tem valor.");
